...
public interface OrderInfoService extends IService<OrderInfo> {
    ...
    ResponseResult batchAdd(BatchAddVO vo);

    ResponseResult batchUpdate(BatchUpdateVO vo);

    ResponseResult delete(String id);

    void pickupMethodx(String pickupMethodx ,String id);

    BootstrapTableVO<OrderInfoVo> getDashboardData(String startDate, String endDate, Page<OrderInfo> page, String kuidi);

    ResponseResult placeOrder(OrderInfo orderInfo);
}
