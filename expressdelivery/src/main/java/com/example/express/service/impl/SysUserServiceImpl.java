...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public ResponseResult setSex(SysUser user, SexEnum sexEnum) {
        ...
        SysUser users = sysUserService.getByName(name);
        users.setSex(sexEnum);
    ...
    public ResponseResult setSchoolInfo(SysUser user, Integer schoolId, String studentIdCard) {
        ...
        users.setSchoolId(schoolId);
        users.setStudentIdCard(studentIdCard);
        if(!updateById(users)) {
            return ResponseResult.failure(ResponseErrorCodeEnum.OPERATION_ERROR);
        }
        return ResponseResult.success();
    ...
    @Override
    public ResponseResult setSj(String tel) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String name = authentication.getName();
        SysUser user = this.getByName(name);
        user.setTel(tel);
